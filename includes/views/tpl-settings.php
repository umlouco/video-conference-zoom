    ...
    <div class="zvc-row">
                ...
                <table class="form-table">
                    ...
                    <tr class="enabled-vanity-url">
                        ...
                        <td>
                            ...
                            <a href="https://support.zoom.us/hc/en-us/articles/215062646-Guidelines-for-Vanity-URL-Requests">Read more about Vanity
                                URLs</a>
                        </td>
                    </tr>
                ...
                <div class="zoom-api-basic-usage">
                    ...
                    <div class="zoom-api-basic-usage-description">
                        ...
                        <ul>
                            ...
                            <li><strong>link_only</strong> : Yes or No - Adding yes will show join link only. Removing this parameter from shortcode
        ...
        <div class="zvc-position-floater-right">
            <ul class="zvc-information-sec">
                <li>
                    <a target="_blank" href="<?php echo ZVC_PLUGIN_AUTHOR; ?>/zoom-conference-wp-plugin-documentation/"><?php _e( 'Documentation', 'video-conferencing-with-zoom-api' ); ?></a>
                </li>
                <li>
            ...
            <div class="zvc-information-sec">
                ...
                <p>Integrate your Zoom Meetings directly to WooCommerce or WooCommerce booking products. Zoom Integration for WooCommerce allows you
                    to automate your zoom meetings directly from your WordPress dashboard by linking zoom meetings to your WooCommerce or WooCommerce
                    Booking products automatically. Users will receive join links in their booking confirmation emails.</p>
                <p><a href="https://www.codemanas.com/downloads/zoom-integration-for-woocommerce-booking/" class="button button-primary">More
                        Details</a></p>
            </div>
            <div class="zvc-information-sec">
                <h3>Need Idle Auto logout ?</h3>
                <p>Protect your WordPress users' sessions from shoulder surfers and snoopers!</p>
                <p>Use the Inactive Logout plugin to automatically terminate idle user sessions, thus protecting the site if the users leave
                    unattended sessions.</p>
                <p>
