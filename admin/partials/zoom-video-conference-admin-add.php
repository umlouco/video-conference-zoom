...
<div id="post-body" class="metabox-holder columns-2">
  <form action="?page=add_meeting" method="POST">
    <div id="post-body-content" style="position: relative;">
      <div id="titlediv">
        <div id="titlewrap">
          <input type="text" placeholder="Meeting Topic" required name="meetingTopic" size="30" value="" id="title" class="meetingTopic" <?php echo (get_option('zoom_api_key') && get_option('zoom_api_secret')) ? null : 'disabled'; ?>>
        </div>
      </div>
    </div>
            ...
            <table class="zoom_api_table">
              ...
              <tr>
                ...
                <td><select name="meetingType" id="meetingType">
                  <option value="2"><?php _e('Scheduled Meeting', 'zoom-video-conference'); ?></option>
                </select></td>
              </tr>
              <tr>
                <th><?php _e('Start Date/Time: ', 'zoom-video-conference'); ?></th>
                <td><input type="text" name="start_date" required id="datepicker1" value="">
                  <input type="text" name="start_time" required class="timepicker1" value=""></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td><input type="text" required name="duration" value=""></td>
                </tr>
                <tr>
                  <th><?php _e('Enable join before host', 'zoom-video-conference'); ?></th>
                  <td><input type="radio" name="join_before_host" value="true"> Yes
                      <input type="radio" name="join_before_host" value="false" checked> No</td>
                </tr>
                <tr>
                  <th><?php _e('Enable Participants Video', 'zoom-video-conference'); ?></th>
                  <td><input type="radio" name="option_participants_video" value="true"> Yes
                    <input type="radio" name="option_participants_video" value="false" checked> No</td>
                  </tr>
                  <tr>
